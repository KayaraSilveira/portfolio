...
const projects: ProjectModel[] = [
    ...
    new ProjectModel(
        0, 
        "Abrace", 
        "Plataforma de dedicada à promoção de projetos solidários e ao apoio à comunidade.", 
        "abrace/abrace.png", 
    ...
    new ProjectModel(
        1, 
        "Shop Me", 
        "Simulação de um e-commerce, demonstrando o funcionamento de um algoritmo de recomendação utilizando database orientado a grafo.", 
        "shopme/shopme.png", 
    ...
    new ProjectModel(
        2, 
        "Voice Transcriber", 
        "Aplicativo web desenvolvido como uma proposta de prática pedagógica para alunos surdos e deficientes auditivos", 
    ...
    new ProjectModel(
        4, 
        "To do list", 
        "Uma to do list realizada para a consolidação dos meus estudos de Django e Python", 
        "todolist/todolist.png", 
        ["Python", "Django", "JavaScript", "Ajax", "HTML", "CSS"], 
        "Este é um projeto de lista de tarefas (To-Do List) que permite aos usuários gerenciar suas tarefas diárias de forma eficiente. Com uma interface simples e amigável, os usuários podem adicionar, editar, marcar como concluídas e excluir tarefas com facilidade, além de criar listas compartilhadas com outros usuários", 
